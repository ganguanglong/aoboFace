...
public class LoadingActivity extends Activity implements Serializable {
    ...
    private void initData() {
        ...
        if (StaticClass.API_KEY == null || StaticClass.API_SECRET == null) {
    ...
    private void network() {
        ...
        licenseManager.takeLicenseFromNetwork(uuid, StaticClass.API_KEY, StaticClass.API_SECRET, apiName,
                LicenseManager.DURATION_30DAYS, "Landmark", "1", true, new LicenseManager.TakeLicenseCallback() {
                    ...
                    public void onFailed(int i, byte[] bytes) {
                        Toast.makeText(LoadingActivity.this,new String(bytes),Toast.LENGTH_LONG).show();
