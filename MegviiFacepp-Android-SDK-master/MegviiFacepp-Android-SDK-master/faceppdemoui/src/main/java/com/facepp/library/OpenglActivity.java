        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
//                        Toast.makeText(OpenglActivity.this,"验证失败",Toast.LENGTH_SHORT).show();
                        Log.i(TAG, "验证失败！");
...
//                            Log.i(TAG, "老朋友判断:，现在 face_token_new="+face_token_know);
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
//                            Toast.makeText(OpenglActivity.this,"网络繁忙，请重试！",Toast.LENGTH_SHORT).show();
                            Log.i(TAG, "网络繁忙，请重试！");
                        }
                    });
                } else

                {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
//                            Toast.makeText(OpenglActivity.this,"网络出现问题，请重试！",Toast.LENGTH_SHORT).show();
